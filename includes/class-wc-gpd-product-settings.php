...
class WC_GPD_Product_Settings {
	...
	const DEFAULTS = array(
		...
		'customer_add_text_font_palette_id' => '',
		...
		'use_same_fonts_entire_template'  => false,
	...
	public static function save( $product_id, array $settings ) {
		...
		$clean = array(
			...
			'allow_shape_color'       => ! empty( $settings['allow_shape_color'] ),
			'allow_shape_move'        => ! empty( $settings['allow_shape_move'] ),
			'allow_shape_resize'      => ! empty( $settings['allow_shape_resize'] ),
			'allow_icon_color'        => ! empty( $settings['allow_icon_color'] ),
			'allow_icon_move'         => ! empty( $settings['allow_icon_move'] ),
			'allow_icon_resize'       => ! empty( $settings['allow_icon_resize'] ),
			...
			'customer_add_text_font_palette_id' => self::sanitize_palette_id( $settings['customer_add_text_font_palette_id'] ?? '' ),
			...
			'use_same_fonts_entire_template'  => ! empty( $settings['use_same_fonts_entire_template'] ),
	...
	public static function from_post( array $post ) {
		return array(
			...
			'allow_shape_color'       => ! empty( $post['wc_gpd_ps_allow_shape_color'] ),
			'allow_shape_move'        => ! empty( $post['wc_gpd_ps_allow_shape_move'] ),
			'allow_shape_resize'      => ! empty( $post['wc_gpd_ps_allow_shape_resize'] ),
			'allow_icon_color'        => ! empty( $post['wc_gpd_ps_allow_icon_color'] ),
			'allow_icon_move'         => ! empty( $post['wc_gpd_ps_allow_icon_move'] ),
			'allow_icon_resize'       => ! empty( $post['wc_gpd_ps_allow_icon_resize'] ),
			...
			'customer_add_text_font_palette_id' => self::sanitize_palette_id( $post['wc_gpd_ps_customer_add_text_font_palette_id'] ?? '' ),
			...
			'use_same_fonts_entire_template'  => ! empty( $post['wc_gpd_ps_use_same_fonts'] ),
